...
while ($res = mysqli_fetch_array($rs)) {
    ...
    if ($ret = mysqli_fetch_array($rt)) {
        ...
        echo "<td>" . $res['quantity'] . "</td>";
        echo "<td>" . $res['item_type'] . "</td>";
        echo "<td><a class='btn btn-sm btn-warning' href='request_item_amount_user.php?id=" . $res['id'] . "&action=request&quantity=" . $res['quantity'] . "&user_type=supply_user'>Request Item</a></td>";
        echo "</tr>";
    }
}
?>
