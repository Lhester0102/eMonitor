...
<body>
    <div class="sidebar">
        <a href="request_index_ph.php">Back</a>
    </div>  

    <form id="requestForm" method="post" action="request_item_head.php?id=<?php echo $id; ?>&action=request&quantity=<?php echo $quantity; ?>" required>
        <table>
            <tr>
                <td>Request Amount: <input type="number" name="requesta" id="requestAmount" min=1 style="width: 100%;" required> </td>
            </tr>
