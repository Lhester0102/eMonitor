...
if(isset($_POST['search_btn'])) {
    ...
    $query = "SELECT inventory.*, COALESCE(SUM(borrowed_item.borrowed_amount), 0) AS total_borrowed_amount 
              ...
              WHERE (inventory.id LIKE '%$searchTerm%' OR inventory.item_code LIKE '%$searchTerm%' OR inventory.equipment_name LIKE '%$searchTerm%' OR inventory.equipment_brand LIKE '%$searchTerm%' OR inventory.quantity LIKE '%$searchTerm%') AND inventory.locate = 'BSBA'
...
<div class="container mt-4">
    <div class="card">
        <div class="card-header">
            <h3 class="text-center">BSBA Inventory</h3>
        </div>
        <br>
    ...
    <a href="bsba_index.php" class="btn btn-primary">BSBA Inventory</a>
