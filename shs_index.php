...
if(isset($_POST['search_btn'])) {
    ...
    $query = "SELECT inventory.*, COALESCE(SUM(borrowed_item.borrowed_amount), 0) AS total_borrowed_amount 
              ...
              WHERE (inventory.id LIKE '%$searchTerm%' OR inventory.item_code LIKE '%$searchTerm%' OR inventory.equipment_name LIKE '%$searchTerm%' OR inventory.equipment_brand LIKE '%$searchTerm%' OR inventory.quantity LIKE '%$searchTerm%') AND inventory.locate = 'SHS'
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.0/js/bootstrap.bundle.min.js"></script>
	...
	<?php include("navigations.php"); ?>
		...
		<div class="sidebar p-1">
			...
			<a class="me-1 btn btn-secondary"   href="unarchive.php?where=SHS">Archive List</a>
...
<div class="container mt-4">
    <div class="card">
        <div class="card-header">
            <h3 class="text-center">SHS Inventory</h3>
        </div>
        <br>
    ...
    <a href="shs_index.php" class="btn btn-primary">SHS Inventory</a>
    ...
    <tbody>
        ...
        echo "<tr><td colspan='8' class='text-center'>Error fetching inventory data: " . mysqli_error($mysqli) . "</td></tr>";
    }
