    ...
    <div class="container">
        ...
        <?php
            ...
            if(isset($_GET['barcode'])) {
                ...
                $sql = "SELECT * FROM merch WHERE barcode = '$barcode'";
        ...
        <div class="product-info">
            ...
            <div align="center">
                <img class='myImg' src='barcode/<?php echo $product['barcode']; ?>.png' alt='<?php echo $product['barcode']; ?>' style='height: 40px; border: 2px solid #000;'> <br><br>
                <label>Name:</label>
                <input type="text" value="<?php echo $product['name']; ?>" readonly><br><br>
                <label>Quantity:</label>
                <input type="text" value="<?php echo $product['quantity']; ?>" readonly><br><br>
                <label>Measurement:</label>
                <input type="text" value="<?php echo $product['measurement']; ?>" readonly><br><br>
            </div>
        </div>
        <?php
                } else {
