...
if (!$acce) {
    ...
    while ($ace = mysqli_fetch_array($acce)) {
        if ($ace['type'] == 'accept') {
            ...
            echo "<p>Your request for <b><u>" . $ace['amount'] . "</u></b> of <b><u>" . $ace['equipment_name'] . "</u></b> is approved. <b><a href='remove_notification.php?id=" . $ace['AAID'] . "'>See</a></b></p>";
            echo "</div>";
        } else {
            echo "<div class='item-row'>";
            echo "<p>Your request for <b><u>" . $ace['amount'] . "</u></b> of <b><u>" . $ace['equipment_name'] . "</u></b> is denied. Reason: <u>" . $ace['reason'] . "</u> <b><a href='remove_notification.php?id=" . $ace['AAID'] . "'>Remove Notification</a></b></p>";
            echo "</div>";
        }
    }
}
...
while ($roo = mysqli_fetch_assoc($res_today)) {
    echo "<div class='item-row'>";
    echo "<p>The borrowed Equipment <b><u>" . $roo['equipment_name'] . "</u></b> is due today. <b><a href='borrowed_item.php'>See</a></b></p>";
    echo "</div>";
}
while ($roo = mysqli_fetch_assoc($res_passed)) {
    echo "<div class='item-row'>";
    echo "<p>The borrowed Equipment <b><u>" . $roo['equipment_name'] . "</u></b> has passed its due date. <b><a href='borrowed_item.php'>See</a></b></p>";
    echo "</div>";
}
while ($roo = mysqli_fetch_assoc($res_tomorrow)) {
    echo "<div class='item-row'>";
    echo "<p>The borrowed Equipment <b><u>" . $roo['equipment_name'] . "</u></b> is due tomorrow. <b><a href='borrowed_item.php'>See</a></b></p>";
    echo "</div>";
}
?>
