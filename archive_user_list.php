...
if(isset($_POST['search_btn'])) {
    ...
    $query = "SELECT * FROM archive_user WHERE (username LIKE '%$searchTerm%' OR password LIKE '%$searchTerm%' OR email LIKE '%$searchTerm%' OR department LIKE '%$searchTerm%' OR position LIKE '%$searchTerm%' OR iid LIKE '%$searchTerm%') AND user_type LIKE 'user'";
    $rs = mysqli_query($mysqli, $query);
} elseif(isset($_POST['search_reset'])) {
    $searchTerm = "";
    $rs = mysqli_query($mysqli, "SELECT * FROM archive_user WHERE user_type LIKE 'user'");
} else {
    $rs = mysqli_query($mysqli, "SELECT * FROM archive_user WHERE user_type LIKE 'user'");
}
?>
...
<script>
    function unarchiveItemConfirmation(itemId) {
        ...
        document.getElementById('confirmUnarchiveBtn').addEventListener('click', function() {
            window.location.href = 'unarchive_user.php?id=' + itemId + '&type=user';
        });
    }
    ...
    function permanentDeleteConfirmation(itemId) {
        ...
        document.getElementById('confirmPermanentDeleteBtn').addEventListener('click', function() {
            window.location.href = 'permanent_delete_user.php?id=' + itemId + '&type=user';
        });
    }
</script>
</body>
