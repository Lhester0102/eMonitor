...
while ($res = mysqli_fetch_array($rs)) {
    ...
    if ($ret = mysqli_fetch_array($rt)) {
        if ($ret['rname'] == $name) {
            ...
            echo "<td>" . $res['Locate'] . "</td>";
            echo "<td><a class='btn btn-sm btn-danger' href='request_item_head.php?id=" . $res['id'] . "&action=cancel'>Cancel Request</a></td>";
            echo "</tr>";
        }
    } else {
        echo "<tr align='center'>";
        ...
        echo "<td>" . $res['item_type'] . "</td>";
        echo "<td>" . $res['Locate'] . "</td>";
        echo "<td><a class='btn btn-sm btn-warning' href='request_item_amout_head.php?id=" . $res['id'] . "&action=request&quantity=" . $res['quantity'] . "&user_type=user'>Request Item</a></td>";
        echo "</tr>";
    }
}
?>
